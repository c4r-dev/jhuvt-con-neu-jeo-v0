                  ...
                  <table>
                    ...
                    <tbody>
                      {controlGroups.map((control, index) => (
                        ...
                        >
                          <td className="control-title">{control.title}</td>
                          <td className="control-description">{control.subtext || '-'}</td>
                          <td className="submission-info">Submission #{control.submissionIndex}</td>
                          <td className="date-info">{control.submissionDate}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                    ...
                    <tbody>
                      {validatedSteps.map((step, index) => (
                        <tr 
                          ...
                          style={{ cursor: 'pointer' }}
                        >
                          <td className="validation-text">{step.validationText}</td>
                          <td className="node-labels">
                            {step.nodeLabels.length > 0 ? step.nodeLabels.join(', ') : 'No nodes specified'}
                          </td>
                          <td className="submission-info">Submission #{step.submissionIndex}</td>
                          <td className="date-info">{step.timestamp}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
